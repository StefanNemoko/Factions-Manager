...
class LightOpenID
{
    ...
    protected function request_curl($url = '', $method='GET', $params=array(), $update_claimed_id = 0)
    {
    ...
    protected function request_streams($url = '', $method='GET', $params=array(), $update_claimed_id = 0)
    {
